...
namespace DataDomain
{
    public static class Globals
    {
        public enum SUPPORTED_TOKENS
        {
            ...
            PLOT,SIN,COS,TAN,LOG,LN,SQRT,ROOT,ABS,FIBONACCI,FACTORIAL //supported functions
        };
        ...
        public static List<string> keyWords = new List<string>() { "plot","sin","cos","tan","log","ln","sqrt","root","abs","fib","fac"};
        ...
        public static SUPPORTED_TOKENS getTokenFromKeyword(string word)
        {
            ...
            {
                return SUPPORTED_TOKENS.FACTORIAL;
            }
            else
            {
